class Strings {
  ...
  static String sWelcome = 'Bienvenido a Assurance Manager';
  static String sForgotPassword = 'Olvidé mi contraseña';
  static String sIniciarSesion = 'Iniciar sesión';
  static String sNoTienesCuenta = '¿Aun no tienes cuenta?';
  ...
  static String sNombreCompleto = 'Nombre completo';
  static String sTelefono = 'Teléfono';
  static String sPasswordConfirm = 'Confirmar contraseña';
  static String sAceptaTerminosYCondiciones =
      'Acepta los términos y condiciones';
  static String sAceptoTerminosYCondiciones =
      'Acepto los términos y condiciones';
  static String sRegistrarme = 'Registrarme';
  static String sErrorNombreEmpty = 'Por favor ingresa tu nombre completo';
  static String sErrorTelefonoEmpty = 'Por favor ingresa tu telefono';
  static String sErrorTelefonoFormat =
      'El teléfono debe contener mínimo 10 dígitos';
  static String sErrorPasswordFormat =
